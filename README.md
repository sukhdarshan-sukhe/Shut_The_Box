...
```
cd existing_repo
git remote add origin https://labcode.mdx.ac.uk/Sukhe/shut_the_box.git
git branch -M main
...
- [ ] [Set up project integrations](https://labcode.mdx.ac.uk/Sukhe/shut_the_box/-/settings/integrations)
